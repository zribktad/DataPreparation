...
public class OrderControllerIntegrationTest
{
    ...
    public void AddStatus_ReturnsOkResult_And_ChangesOrderStatus()
    {
        ...
        var controller = new OrderController(loggerMock.Object, orderServiceMock.Object,
            orderManagementServiceMock.Object, orderStatusServiceMock.Object, orderItemServiceMock.Object,
    ...
    public void PostComplaint_WithInvalidData_ReturnsNotFoundResult()
    {
        ...
        long orderId = 1;
        var complaint = new ComplaintDTO { Reason = "Bad quality" };
        _orderManagementServiceMock.Setup(x => x.AddComplaintToOrder(orderId, complaint))
    ...
    public void PutComplaint_WithInvalidData_ReturnsNotFoundResult()
    {
        ...
        long orderId = 1;
        var complaint = new ComplaintDTO { Reason = "Bad quality" };
        _orderManagementServiceMock.Setup(x => x.UpdateComplaintStatus(orderId, complaint))
            .Throws<InvalidOperationException>();
    ...
    public void GetItems_ReturnsOkResult_WithListOfItems()
    {
        ...
        {
            new() { Order = order, ItemId = 1, Quantity = 2, Cost = 10 },
            new() { Order = order, ItemId = 2, Quantity = 1, Cost = 20 }
        };
    ...
    public void GetReceipt_ReturnsOkResult_WithReceipt()
    {
        ...
        var _controller = new OrderController(null, _orderServiceMock.Object, null, null, _orderItemServiceMock.Object,
        ...
        var orderItems = new List<OrderItem>
        {
            new() { ItemId = 1, Quantity = 2, Cost = 10 },
            new() { ItemId = 2, Quantity = 1, Cost = 20 }
        };
