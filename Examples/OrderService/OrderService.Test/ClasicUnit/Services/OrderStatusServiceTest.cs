...
public class OrderStatusServiceTest
{
    ...
    public void AddOrderStatus_ValidOrderIdAndStatusDto_ReturnsTrue()
    {
        ...
        mockOrderStatusRepository.Setup(repo => repo.Insert(It.IsAny<OrderStatus>())).Returns(new OrderStatus
        {
        ...
        var orderStatusService = new OrderStatusService(mockOrderStatusRepository.Object, mockOrderRepository.Object,
            null, null, mockFactoryClient.Object);
    ...
    public void GetOrderStatuses_ValidOrderId_ReturnsOrderStatuses()
    {
        ...
        {
            Id = orderId,
            OrderStatuses = new List<OrderStatus> { new() { Status = Status.SENT, StatusDate = DateTime.Now } }
        };
