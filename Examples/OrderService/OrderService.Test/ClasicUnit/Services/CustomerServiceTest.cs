...
public class CustomerServiceTest
{
    ...
    public void GetAllCustomers_Returns_All_Customers()
    {
        ...
        {
            new() { Id = 1, Name = "Customer 1", Address = new Address() },
            new() { Id = 2, Name = "Customer 2", Address = new Address() }
        };
    ...
    public void GetCustomerById_Returns_Customer_If_Found_In_Database()
    {
        ...
        mockRepository.Setup(repo =>
                repo.GetById(customerId, It.IsAny<Func<IQueryable<Customer>, IQueryable<Customer>>>()))
    ...
    public void GetCustomerById_Throws_Exception_If_Not_Found_In_Database()
    {
        ...
        var mockRepository = new Mock<IRepository<Customer>>();
        mockRepository.Setup(repo =>
                repo.GetById(nonExistentCustomerId, It.IsAny<Func<IQueryable<Customer>, IQueryable<Customer>>>()))
