...
public class SQLiteOrderServiceBoaClassicTests
{
    ...
    public void CreateOrder_FullOrderDTO_ReturnsOrder()
    {
        ...
        var orderService = new Services.OrderService(orderRepository, customerRepository);
    ...
    public async Task CreateCustomer_CreateOrder()
    {
        ...
        var customerDto = new CustomerDTO
            { Name = "John Doe", Email = "john.doe@example.com", Address = address, Phone = "000" };
        ...
        var orderItems = new List<OrderItem> { orderItem1, orderItem2 };
        var orderDto = new OrderDTO { CustomerId = createdCustomer.Id, OrderItems = orderItems };
