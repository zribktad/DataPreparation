...
public class CustomerServiceDataTest : IDataPreparationTestServices
{
    ...
    [Test]
    [UsePreparedDataParams(typeof(CustomerServiceData.GetCustomerByIdData), [5L, "Customer 1"], [5L])]
    ...
    [Test]
    [UsePreparedDataParamsFor(typeof(CustomerService), nameof(CustomerService.GetCustomerById), [1L, "Customer 1"],
        [1L])]
