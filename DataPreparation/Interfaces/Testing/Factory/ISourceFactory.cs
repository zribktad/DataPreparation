...
public interface ISourceFactory
{
    ...
    public IList<T> New<T, TDataFactory>(int size, IEnumerable<IDataParams?>? argsEnumerable = null) where TDataFactory : IDataFactory<T> => New<T, TDataFactory>(size, out _, argsEnumerable);
    ...
    /// <param name="argsEnumerable">Optional parameters for data creation.</param>
    /// <returns>A list of new instances of type T.</returns>
    public IList<T> New<T, TDataFactory>(int size, out IList<long> createdIds, IEnumerable<IDataParams?>? argsEnumerable = null) where TDataFactory : IDataFactory<T>;
    ...
    public IEnumerable<T> Was<T, TDataFactory>(IDataParams? args = null) where TDataFactory : IDataFactory<T> => Was<T, TDataFactory>(out _, args);
    ...
    /// <param name="args">Optional parameters for data retrieval.</param>
    /// <returns>An enumerable of existing instances of type T.</returns>
    public IEnumerable<T> Was<T, TDataFactory>(out IEnumerable<long> ids, IDataParams? args = null) where TDataFactory : IDataFactory<T>;
    ...
    public T? Get<T, TDataFactory>() where TDataFactory : IDataFactory<T> => Get<T, TDataFactory>(out _);
    ...
    /// <param name="size">The number of instances to retrieve.</param>
    /// <returns>A list of instances of type T, or null if not found.</returns>
    public IList<T>? Get<T, TDataFactory>(int size) where TDataFactory : IDataFactory<T> => Get<T, TDataFactory>(size, out _);
